...
Original file is located at
    https://colab.research.google.com/drive/1do8Rc7L-9L3SHPSeywnzNeWBhVGH7UwL
"""
...
print("Loading graphs for Ablation Study (Depth: 5 Layers)...")
try:
...
FINAL_MODEL_PATH = ABLATION_SAVE_DIR / 'ss_dgnn_5layer_ablation.pt'
...
TEMP_MODEL_FILE = 'ablation_temp_best_depth5.pt'
...
print(f"Saving best 5-Layer model to: {FINAL_MODEL_PATH}")
...
print(f"=== RESULTS FOR 5-Layer Deep GNN ===")
