...
Original file is located at
    https://colab.research.google.com/drive/19IB3ZTmkA4SKanFoDVu9FYE6W0bR4bxZ
"""
...
print("Loading graphs for Ablation Study (Depth: 3 Layers)...")
try:
...
FINAL_MODEL_PATH = ABLATION_SAVE_DIR / 'ss_dgnn_3layer_ablation.pt'
...
TEMP_MODEL_FILE = 'ablation_temp_best_depth.pt'
...
print(f"Saving best 3-Layer model to: {FINAL_MODEL_PATH}")
...
print(f"=== RESULTS FOR 3-Layer Deep GNN ===")
