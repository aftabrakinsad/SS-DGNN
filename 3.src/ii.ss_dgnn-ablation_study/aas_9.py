...
Original file is located at
    https://colab.research.google.com/drive/1FmUQJ5TivdfGdfs-5WJmdcZvRHjO0nHZ
"""
...
print("Loading graphs for Ablation Study (Optimizer: SGD)...")
try:
...
FINAL_MODEL_PATH = ABLATION_SAVE_DIR / 'ss_dgnn_sgd_ablation.pt'
...
TEMP_MODEL_FILE = 'ablation_temp_best_sgd.pt'
...
print(f"Saving best SGD model to: {FINAL_MODEL_PATH}")
...
print(f"=== RESULTS FOR OPTIMIZER = SGD ===")
