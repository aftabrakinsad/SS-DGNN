...
Original file is located at
    https://colab.research.google.com/drive/18aReBwvbsov_7mCtP9Z69ApHj0gVJGUf
"""
...
print("Loading graphs for Ablation Study (GATConv)...")
try:
...
FINAL_MODEL_PATH = ABLATION_SAVE_DIR / f'ss_dgnn_{ABLATION_LAYER_TYPE.lower()}_ablation.pt'
...
TEMP_MODEL_FILE = 'ablation_temp_best_gat.pt'
...
print(f"Saving best {ABLATION_LAYER_TYPE} model to: {FINAL_MODEL_PATH}")
...
print(f"=== RESULTS FOR {ABLATION_LAYER_TYPE} ===")
